...
Examples:
Build firmware for the "RAK_4631_companion_radio" device target
$ sh build.sh build-firmware RAK_4631_companion_radio
...
build_firmware() {
  ...
  # craft filename
  # e.g: RAK_4631_companion_radio-v1.0.0-SHA
  ...
  # build merge-bin for esp32 fresh install, copy .bins to out folder (e.g: Heltec_v3_companion_radio-v1.0.0-SHA.bin)
  ...
  # build .uf2 for nrf52 boards, copy .uf2 and .zip to out folder (e.g: RAK_4631_companion_radio-v1.0.0-SHA.uf2)
...
#  build_firmware "t1000e_companion_radio_ble"
  ...
  # build all companion firmwares
  build_all_firmwares_by_suffix "_companion_radio"
  build_all_firmwares_by_suffix "_companion_observer"
